...
{
	private static final Logger logger = LogManager.getLogger(CustomUserApprovalHandler.class);
			...
			Authentication userAuthentication)
	{
		...
		logger.info("checkForPreApproval method entered: " + authorizationRequest.getClientId());
