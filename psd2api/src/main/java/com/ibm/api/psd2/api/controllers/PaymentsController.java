...
public class PaymentsController extends APIController
{
	...
	public @ResponseBody ResponseEntity<ResponseBean> createTransactionRequest(
			...
			@RequestBody TxnRequestBean trb, Authentication auth)
	{
		...
		try
		{
			...
			TxnRequestDetailsBean t = pdao.createTransactionRequest(trb, payee, user, viewId, txnType);
	...
	public @ResponseBody ResponseEntity<ResponseBean> answerTransactionChallenge(
			@PathVariable("bankId") String bankId, @PathVariable("accountId") String accountId,
			@PathVariable("viewId") String viewId, @PathVariable("txnType") String txnType,
			@PathVariable("txnReqId") String txnReqId, @RequestBody TxnChallengeAnswerBean t,
			Authentication auth)
	{
		ResponseEntity<ResponseBean> response;
		try
		{
			...
			TxnRequestDetailsBean tdb = pdao.answerTransactionRequestChallenge(user, viewId, bankId, accountId, txnType, txnReqId, t);
	...
	public @ResponseBody ResponseEntity<List<ResponseBean>> getTransactionRequests(
			@PathVariable("bankId") String bankId, @PathVariable("accountId") String accountId,
			@PathVariable("viewId") String viewId, Authentication auth)
	{
		...
		try
		{
			...
			List<ResponseBean> txns = pdao.getTransactionRequests(user, viewId, accountId, bankId);
